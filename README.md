...
Because this project relies on ES Modules and WebGL/Three.js assets, running directly via `file://` will fail due to CORS policies. You must run it through a local HTTP server.
